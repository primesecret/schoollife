package com.seungho.schoollife.presentation.paging

import androidx.paging.PagingSource
import androidx.paging.PagingState
import com.seungho.schoollife.data.api.ApiService
import com.seungho.schoollife.data.dto.RickMorty

class RickyMortyPagingSource(private val apiService: ApiService) : PagingSource<Int, RickMorty>(){
